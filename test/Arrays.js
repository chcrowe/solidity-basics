...
describe('Arrays', () => {
  ...
  describe('Example 1', () => {
    ...
    it('demonstrates array initialization & types', async () => {
      ...
      expect(await contract.array7(0)).to.equal("0xBcd4042DE499D14e55001CcbB24a551F3b954096")
      expect(await contract.array7(1)).to.equal("0x71bE63f3384f5fb98995898A86B02Fb2426c5788")
      expect(await contract.array7(2)).to.equal("0xFABB0ac9d68B0B445fB7357272Ff202C5651694a")
